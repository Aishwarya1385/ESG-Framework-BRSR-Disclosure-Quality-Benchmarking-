...
*Business Responsibility and Sustainability Reports, assessed against India's SEBI/BRSR regulatory framework*

> An Indian-regulatory-first disclosure quality assessment. International framework alignment (GRI, IFRS S1/S2, TCFD) is a forward roadmap item — see [Roadmap](#8-roadmap-migration-to-international-esg-frameworks) — and is **not** used to score any company in this version.

**Coverage:** 27 of 50 Nifty constituents · **Confidential — for internal/client use**
...
This benchmark evaluates the depth and quality of **Business Responsibility and Sustainability Report (BRSR)** disclosures across **27 Nifty 50 companies** spanning six sectors, scored 0–3 per metric across the Environment, Social and Governance pillars (0 = no disclosure, 3 = comprehensive quantitative disclosure with assurance). Unlike a generic ESG scorecard, every metric here is anchored to a specific BRSR reporting requirement under Indian securities law — principally the **SEBI (LODR) Regulations, 2015** and the **BRSR Core circular of July 2023** — so gaps read as compliance-maturity gaps, not abstract sustainability opinions.

**Three findings stand out:**

- **Environmental disclosure is the strongest and most consistent pillar** (sector averages 73–96%), and this tracks the law closely: 6 of the 12 Environment metrics benchmarked fall within SEBI's mandatorily-assured **BRSR Core** attributes (GHG Footprint, Water Footprint, Energy Footprint, Embracing Circularity). The two persistent gaps — Scope 3 emissions and water-recycling % — are precisely the two Environment data points that sit outside, or only partially inside, the BRSR Core assurance perimeter today.
- **Governance is the weakest and most uneven pillar** (48–72% by sector). This isn't incidental: **none** of the 7 Governance metrics benchmarked are BRSR Core attributes — BRSR Core's nine attributes skew toward Environment and workforce-Social KPIs, leaving Governance items (anti-corruption policy, board ESG oversight, independent-director composition) governed only by the unassured "Essential Indicator" tier of full BRSR, or by separate statutes this benchmark doesn't directly score.
- **Sector averages conceal material within-sector variance:** Healthcare contains both the top-rated company nationally (Dr. Reddy's Laboratories, 95.1) and a bottom-quartile company (Apollo Hospitals Enterprise, 63.9). A sector-level BRSR score alone would misstate individual-company disclosure maturity.

> **Scope note:** All companies were assessed using their publicly available BRSR filings — the official annual-report BRSR annexure where traceable via NSE/BSE, or the BRSR published on the company's own website otherwise. This benchmark scores **disclosure quality and completeness against BRSR's own required format**, not underlying sustainability performance. A company can score well by transparently reporting a poor number, and poorly by omitting a good one.

---

## 1. The Indian Regulatory Basis for This Benchmark

This benchmark deliberately scores companies **only against what Indian law and SEBI regulation currently require or encourage them to disclose**. International frameworks are referenced only in [Section 8](#8-roadmap-migration-to-international-esg-frameworks) as a forward migration path.

### 1.1 Statutory Foundation of BRSR

- **SEBI (LODR) Regulations, 2015 — Regulation 34(2)(f):** mandates that the annual report of the top 1,000 listed entities by market capitalisation include a BRSR. Replaced the earlier, narrower Business Responsibility Report (BRR) regime with effect from FY2022-23.
- **National Guidelines on Responsible Business Conduct (NGRBC), 2018** — issued by the Ministry of Corporate Affairs (MCA) — supply the nine principles (P1–P9) around which the entire BRSR format is structured.
- **SEBI BRSR Core circular** (SEBI/HO/CFD/CFD-SEC-2/P/CIR/2023/122, 12 July 2023): carved out nine ESG attributes (~49 KPIs) for which in-scope entities must obtain **reasonable assurance** (a higher bar than "limited assurance"). The single most consequential recent change to Indian ESG regulation, and the reference point for most of this benchmark's E/S findings.
- **Companies Act, 2013, s.135 & Schedule VII**, read with the Companies (CSR Policy) Rules, 2014 — mandates minimum CSR spend (2% of average net profits) and underlies the Social pillar's CSR/community-investment disclosures.
- **Companies Act, 2013, s.149(4)** and **SEBI LODR Regulation 17** — govern minimum independent-director composition; s.149(1) further requires at least one woman director. Cross-referenced by two metrics below.
- **Value-chain ESG disclosure:** extended to the top 250 listed entities' material value-chain partners on a comply-or-explain, voluntary basis from FY2024-25.
...
SEBI's BRSR Core is a strict subset of full BRSR — nine attributes selected for mandatory reasonable assurance, phased in by market-capitalisation band. This schedule structurally explains why Environment/workforce-Social metrics disclose far better than Governance metrics: the former sit largely inside the assured perimeter, the latter almost entirely outside it.
...
|---|---|---|
| FY2023-24 | Top 150 listed entities | Reasonable assurance on BRSR Core attributes begins |
| FY2024-25 | Top 250 listed entities | Assurance expands; voluntary value-chain ESG disclosure (comply-or-explain) begins for Top 250 |
| FY2025-26 | Top 500 listed entities | Assurance expands (current reporting year for this benchmark) |
| FY2026-27 | Top 1,000 listed entities | Full BRSR Core assurance coverage; value-chain assurance begins |
